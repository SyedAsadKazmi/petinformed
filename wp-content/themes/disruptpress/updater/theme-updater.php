...
$updater = new EDD_Theme_Updater_Admin(
	...
	// Config settings
	$config = array(
		'remote_api_url' => 'http://disruptpress.com', // Site where EDD is hosted
		'item_name'      => 'DisruptPress Theme', // Name of theme
		'theme_slug'     => 'disruptpress-theme', // Theme slug
		'version'        => DP_VERSION, // The current version of this theme
		'author'         => 'Aedan OBrien', // The author of this theme
