...
Kirki::add_section( 'dp_background2', array(
    'title'          => __( 'Background 2' ),
    'panel' => 'dp_design_options'
) );

$disruptpress_theme_defaults['dp_bg2_height_panel'] = '1';
Kirki::add_field( 'disruptpress_theme', array(
	'type'      => 'radio-buttonset',
	'settings'  => 'dp_bg2_height_panel',
	'label'     => __( 'Background 2', 'my_textdomain' ),
	'section'   => 'dp_background2',
	'default'   => $disruptpress_theme_defaults['dp_bg2_height_panel'],
	'transport'   => 'postMessage',
	'choices'   => array(
		'1' => __( 'Off', 'my_textdomain' ),
		'2' => __( 'Viewport', 'my_textdomain' ),
		'3' => __( 'Full Height', 'my_textdomain' ),
		'4' => __( 'Pixel', 'my_textdomain' ),
	)
) );

$disruptpress_theme_defaults['dp_bg2_height'] = '450';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_bg2_height',
	'description'       => esc_attr__( 'Background Height (px)', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'default'     => $disruptpress_theme_defaults['dp_bg2_height'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '2160',
...
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'custom',
	'settings'    => 'dp_background2_divider1',
	'section'     => 'dp_background2',
	'default'     => '<div class="dp_customizer-divider"></div>',
) );

$disruptpress_theme_defaults['dp_bg2_color_style'] = '1';
Kirki::add_field( 'disruptpress_theme', array(
	'type'      => 'radio-buttonset',
	'settings'  => 'dp_bg2_color_style',
	'label'     => __( 'Background Color Style', 'my_textdomain' ),
	'section'   => 'dp_background2',
	'default'   => $disruptpress_theme_defaults['dp_bg2_color_style'],
	'transport'   => 'postMessage',
	'choices'   => array(
...
$disruptpress_theme_defaults['dp_bg2_color'] = '#CCCCCC';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'color',
	'settings'    => 'dp_bg2_color',
	'description'       => esc_attr__( 'Primary Color', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'transport'   => 'postMessage',
	'default'   => $disruptpress_theme_defaults['dp_bg2_color'],
	'sanitize_callback'     => '',
	'alpha'       => true,
) );

$disruptpress_theme_defaults['dp_bg2_color2'] = '#FFFFFF';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'color',
	'settings'    => 'dp_bg2_color2',
	'description' => esc_attr__( 'Secondary Color', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'transport'   => 'postMessage',
	'default'     => $disruptpress_theme_defaults['dp_bg2_color2'],
	'sanitize_callback'     => '',
	'alpha'       => true,
) );

$disruptpress_theme_defaults['dp_bg2_shade_strenght'] = '-0.5';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_bg2_shade_strenght',
	'description' => esc_attr__( 'Shade Strenght', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'default'     => $disruptpress_theme_defaults['dp_bg2_shade_strenght'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '-1',
		'max'  => '1',
...
$disruptpress_theme_defaults['dp_bg2_gradient_style'] = '1';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'radio-image',
	'settings'    => 'dp_bg2_gradient_style',
	'description' => esc_html__( 'Gradient Style', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'default'     => $disruptpress_theme_defaults['dp_bg2_gradient_style'],
	'transport'   => 'postMessage',
	'choices'     => array(
...
$disruptpress_theme_defaults['dp_bg2_gradient_advanced_toggle'] = '0';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'checkbox',
	'settings'    => 'dp_bg2_gradient_advanced_toggle',
	'label'       => __( 'Advanced Options', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'default'   => $disruptpress_theme_defaults['dp_bg2_gradient_advanced_toggle'],
	'transport'   => 'postMessage',
) );

$disruptpress_theme_defaults['dp_bg2_gradient_position_parameter1'] = '0';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_bg2_gradient_position_parameter1',
	'description'       => esc_attr__( 'Gradient Position Parameter 1', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'default'   => $disruptpress_theme_defaults['dp_bg2_gradient_position_parameter1'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '100',
...
$disruptpress_theme_defaults['dp_bg2_gradient_position_parameter2'] = '100';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_bg2_gradient_position_parameter2',
	'description'       => esc_attr__( 'Gradient Position Parameter 2', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'default'   => $disruptpress_theme_defaults['dp_bg2_gradient_position_parameter2'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '100',
...
$disruptpress_theme_defaults['dp_bg2_gradient_reverse_color'] = '0';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'switch',
	'settings'    => 'dp_bg2_gradient_reverse_color',
	'description'       => __( 'Reverse Colors', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'default'   => $disruptpress_theme_defaults['dp_bg2_gradient_reverse_color'],
	'transport'   => 'postMessage',
	'choices'     => array(
...
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'custom',
	'settings'    => 'dp_background2_divider2',
	'section'     => 'dp_background2',
	'default'     => '<div class="dp_customizer-divider"></div>',
) );
...
//Background Image
$disruptpress_theme_defaults['dp_bg2_img_panel'] = '1';
Kirki::add_field( 'disruptpress_theme', array(
	'type'      => 'radio-buttonset',
	'settings'  => 'dp_bg2_img_panel',
	'label'     => __( 'Background Image', 'my_textdomain' ),
	'section'   => 'dp_background2',
	'default'   => $disruptpress_theme_defaults['dp_bg2_img_panel'],
	'transport'   => 'postMessage',
	'choices'   => array(
...
$disruptpress_theme_defaults['dp_bg2_pattern'] = 'bg_noise_1.png';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'radio-image',
	'settings'    => 'dp_bg2_pattern',
	'label'       => esc_html__( ' ', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'default'   => $disruptpress_theme_defaults['dp_bg2_pattern'],
	'transport'   => 'postMessage',
	'choices'     => array(
...
$disruptpress_theme_defaults['dp_bg2_img_upload'] = '';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'image',
	'settings'    => 'dp_bg2_img_upload',
	'label'       => __( ' ', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'default'     => $disruptpress_theme_defaults['dp_bg2_img_upload'],
	'transport'   => 'postMessage',
) );

$disruptpress_theme_defaults['dp_bg2_img_repeat'] = 'no-repeat';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'select',
	'settings'    => 'dp_bg2_img_repeat',
	'description'       => __( 'Background Repeat', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'default'     => $disruptpress_theme_defaults['dp_bg2_img_repeat'],
	'transport'   => 'postMessage',
	'multiple'    => 1,
	'choices'     => array(
...
$disruptpress_theme_defaults['dp_bg2_img_size'] = 'auto';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'select',
	'settings'    => 'dp_bg2_img_size',
	'description'       => __( 'Background Size', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'default'     => $disruptpress_theme_defaults['dp_bg2_img_size'],
	'transport'   => 'postMessage',
	'multiple'    => 1,
	'choices'     => array(
...
$disruptpress_theme_defaults['dp_bg2_img_attachment'] = 'scroll';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'select',
	'settings'    => 'dp_bg2_img_attachment',
	'description'       => __( 'Background Attachment', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'default'     => $disruptpress_theme_defaults['dp_bg2_img_attachment'],
	'transport'   => 'postMessage',
	'multiple'    => 1,
	'choices'     => array(
...
$disruptpress_theme_defaults['dp_bg2_img_position'] = 'left top';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'select',
	'settings'    => 'dp_bg2_img_position',
	'description'       => __( 'Background Position', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'default'     => $disruptpress_theme_defaults['dp_bg2_img_position'],
	'transport'   => 'postMessage',
	'multiple'    => 1,
	'choices'     => array(
...
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'custom',
	'settings'    => 'dp_background2_divider3',
	'section'     => 'dp_background2',
	'default'     => '<div class="dp_customizer-divider"></div>',
) );

$disruptpress_theme_defaults['dp_bg2_border_bottom_size'] = '0';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_bg2_border_bottom_size',
	'label'       => esc_attr__( 'Border Bottom', 'my_textdomain' ),
	'description'       => esc_attr__( 'Size (px)', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'default'     => $disruptpress_theme_defaults['dp_bg2_border_bottom_size'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '10',
...
$disruptpress_theme_defaults['dp_bg2_border_bottom_color'] = '#FFFFFF';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'color',
	'settings'    => 'dp_bg2_border_bottom_color',
	'description' => esc_attr__( 'Color', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'transport'   => 'postMessage',
	'default'   => $disruptpress_theme_defaults['dp_bg2_border_bottom_color'],
	'sanitize_callback'     => '',
	'alpha'       => false,
) );
...
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'custom',
	'settings'    => 'dp_background2_divider4',
	'section'     => 'dp_background2',
	'default'     => '<div class="dp_customizer-divider"></div>',
) );

$disruptpress_theme_defaults['dp_bg2_shadow_bottom_vertical'] = '0';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_bg2_shadow_bottom_vertical',
	'label'       => esc_attr__( 'Shadow Bottom', 'my_textdomain' ),
	'description' => esc_attr__( 'Vertical', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'default'     => $disruptpress_theme_defaults['dp_bg2_shadow_bottom_vertical'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '-20',
		'max'  => '30',
...
$disruptpress_theme_defaults['dp_bg2_shadow_bottom_blur_radius'] = '0';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_bg2_shadow_bottom_blur_radius',
	'description'  => esc_attr__( 'Blur Radius', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'default'     => $disruptpress_theme_defaults['dp_bg2_shadow_bottom_blur_radius'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '100',
...
$disruptpress_theme_defaults['dp_bg2_shadow_bottom_spread_radius'] = '0';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_bg2_shadow_bottom_spread_radius',
	'description' => esc_attr__( 'Spread Radius', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'default'     => $disruptpress_theme_defaults['dp_bg2_shadow_bottom_spread_radius'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '-20',
		'max'  => '100',
...
$disruptpress_theme_defaults['dp_bg2_shadow_bottom_opacity'] = '0.75';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_bg2_shadow_bottom_opacity',
	'description'       => esc_attr__( 'Opacity', 'my_textdomain' ),
	'section'     => 'dp_background2',
	'default'     => $disruptpress_theme_defaults['dp_bg2_shadow_bottom_opacity'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0.00',
		'max'  => '1.00',
...
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'custom',
	'settings'    => 'dp_background2_divider6',
	'section'     => 'dp_background2',
	'default'     => '<div class="dp_customizer-divider"></div>',
) );
