...
/**
 * Customizer Section - Site Container.
 */
 
// Kirki::add_field( 'disruptpress_theme', array(
// 	'type'        => 'custom',
// 	'settings'    => 'dp_generator',
// 	'label'       => __( 'Generator', 'my_textdomain' ),
// 	'section'     => 'dp_site_container',
// 	//'default'     => '<input class="" type="button" value="Generate" name="_customize-input-dp_generator" id="dp_generator" data-customize-setting-link="dp_generator">',
// 	'default'     => '  <input type="submit" value="Submit">',
// 	'priority'    => 0,
// ) );


Kirki::add_section( 'dp_site_container', array(
	'title'    => __( 'Site Container' ),
	'panel'    => 'dp_design_options'
) );


$disruptpress_theme_defaults['dp_site_layout'] = '1';
Kirki::add_field( 'disruptpress_theme', array(
	'type'      => 'radio-buttonset',
	'settings'  => 'dp_site_layout',
	'label'     => __( 'Website Layout', 'my_textdomain' ),
	'section'   => 'dp_site_container',
	'default'   => $disruptpress_theme_defaults['dp_site_layout'],
...
$disruptpress_theme_defaults['dp_site_container_width'] = '1100';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_site_container_width',
	'description' => esc_attr__( 'Container Width (px)', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'     => $disruptpress_theme_defaults['dp_site_container_width'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '1025',
		'max'  => '1400',
...
$disruptpress_theme_defaults['dp_site_container_wrap_padding_left_right'] = '30';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_site_container_wrap_padding_left_right',
	'description'       => esc_attr__( 'Wrap Padding Left & Right (px)', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'     => $disruptpress_theme_defaults['dp_site_container_wrap_padding_left_right'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '60',
...
$disruptpress_theme_defaults['dp_site_container_site_inner_padding_top'] = '20';
Kirki::add_field( 'disruptpress_theme', array(
    'type'        => 'slider',
    'settings'    => 'dp_site_container_site_inner_padding_top',
    //'label' => esc_attr__( 'Padding', 'my_textdomain' ),
    'description' => esc_attr__( 'Padding Top', 'my_textdomain' ),
    'section'     => 'dp_site_container',
    'default'     => $disruptpress_theme_defaults['dp_site_container_site_inner_padding_top'],
    'transport'   => 'postMessage',
    'choices'     => array(
        'min'  => '0',
        'max'  => '60',
...
$disruptpress_theme_defaults['dp_site_container_margin_top_bottom'] = '0';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_site_container_margin_top_bottom',
	'description'       => esc_attr__( 'Container Margin Top & Bottom (px)', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'     => $disruptpress_theme_defaults['dp_site_container_margin_top_bottom'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '60',
...
$disruptpress_theme_defaults['dp_site_container_margin_left_right'] = '0';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_site_container_margin_left_right',
	'description'       => esc_attr__( 'Container Margin Left & Right (px)', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'     => $disruptpress_theme_defaults['dp_site_container_margin_left_right'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '60',
...
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'custom',
	'settings'    => 'dp_divider_container1',
	'section'     => 'dp_site_container',
	'default'     => '<div class="dp_customizer-divider"></div>',
) );

$disruptpress_theme_defaults['dp_site_container_box_shadow_blur_radius'] = '0';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_site_container_box_shadow_blur_radius',
	'label'       => esc_attr__( 'Container Box Shadow', 'my_textdomain' ),
	'description' => esc_attr__( 'Blur Radius', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'     => $disruptpress_theme_defaults['dp_site_container_box_shadow_blur_radius'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '100',
...
$disruptpress_theme_defaults['dp_site_container_box_shadow_spread_radius'] = '0';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_site_container_box_shadow_spread_radius',
	'description' => esc_attr__( 'Spread Radius', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'     => $disruptpress_theme_defaults['dp_site_container_box_shadow_spread_radius'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '10',
...
$disruptpress_theme_defaults['dp_site_container_box_shadow_opacity'] = '0.75';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_site_container_box_shadow_opacity',
	'description' => esc_attr__( 'Shadow Opacity', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'   => $disruptpress_theme_defaults['dp_site_container_box_shadow_opacity'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '1',
...
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'custom',
	'settings'    => 'dp_divider_container2',
	'section'     => 'dp_site_container',
	'default'     => '<div class="dp_customizer-divider"></div>',
) );

$disruptpress_theme_defaults['dp_site_container_border_style'] = 'none';
Kirki::add_field( 'disruptpress_theme', array(
	'type'      => 'radio-buttonset',
	'settings'  => 'dp_site_container_border_style',
	'label'     => __( 'Container Border Style', 'my_textdomain' ),
	'section'   => 'dp_site_container',
	'default'   => $disruptpress_theme_defaults['dp_site_container_border_style'],
	'transport' => 'postMessage',
	'choices'   => array(
...
$disruptpress_theme_defaults['dp_site_container_border_width_left_right'] = '1';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_site_container_border_width_left_right',
	'description' => esc_attr__( 'Border Width Left & Right', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'     => $disruptpress_theme_defaults['dp_site_container_border_width_left_right'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '10',
...
$disruptpress_theme_defaults['dp_site_container_border_width_top_bottom'] = '1';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_site_container_border_width_top_bottom',
	'description' => esc_attr__( 'Border Width Top & Bottom', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'     => $disruptpress_theme_defaults['dp_site_container_border_width_top_bottom'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '10',
...
$disruptpress_theme_defaults['dp_site_container_border_color'] = '#444444';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'color',
	'settings'    => 'dp_site_container_border_color',
	'description' => esc_attr__( 'Border Color', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'transport'   => 'postMessage',
	'default'     => $disruptpress_theme_defaults['dp_site_container_border_color'],
	'sanitize_callback'     => '',
	'alpha'       => false,
) );
...
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'custom',
	'settings'    => 'dp_divider_container3',
	'section'     => 'dp_site_container',
	'default'     => '<div class="dp_customizer-divider"></div>',
) );

$disruptpress_theme_defaults['dp_site_container_border_radius_topleft'] = '0';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_site_container_border_radius_topleft',
	'description' => esc_attr__( 'Top Left', 'my_textdomain' ),
	'label'       => __( 'Border Radius', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'     => $disruptpress_theme_defaults['dp_site_container_border_radius_topleft'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '100',
...
$disruptpress_theme_defaults['dp_site_container_border_radius_topright'] = '0';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_site_container_border_radius_topright',
	'description' => esc_attr__( 'Top Right', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'     => $disruptpress_theme_defaults['dp_site_container_border_radius_topright'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '100',
...
$disruptpress_theme_defaults['dp_site_container_border_radius_bottomright'] = '0';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_site_container_border_radius_bottomright',
	'description' => esc_attr__( 'Bottom Right', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'     => $disruptpress_theme_defaults['dp_site_container_border_radius_bottomright'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '100',
...
$disruptpress_theme_defaults['dp_site_container_border_radius_bottomleft'] = '0';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_site_container_border_radius_bottomleft',
	'description' => esc_attr__( 'Bottom Left', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'     => $disruptpress_theme_defaults['dp_site_container_border_radius_bottomleft'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '100',
...
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'custom',
	'settings'    => 'dp_site_container_divider4',
	'section'     => 'dp_site_container',
	'default'     => '<div class="dp_customizer-divider"></div>',
) );

$disruptpress_theme_defaults['dp_site_container_color_style'] = '1';
Kirki::add_field( 'disruptpress_theme', array(
	'type'      => 'radio-buttonset',
	'settings'  => 'dp_site_container_color_style',
	'label'     => __( 'Background Color Style', 'my_textdomain' ),
	'section'   => 'dp_site_container',
	'default'   => $disruptpress_theme_defaults['dp_site_container_color_style'],
	'transport'   => 'postMessage',
	'choices'   => array(
...
$disruptpress_theme_defaults['dp_site_container_color'] = '#CCCCCC';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'color',
	'settings'    => 'dp_site_container_color',
	'description'       => esc_attr__( 'Primary Color', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'transport'   => 'postMessage',
	'default'   => $disruptpress_theme_defaults['dp_site_container_color'],
	'sanitize_callback'     => '',
	'alpha'       => true,
) );

$disruptpress_theme_defaults['dp_site_container_color2'] = '#FFFFFF';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'color',
	'settings'    => 'dp_site_container_color2',
	'description'       => esc_attr__( 'Secondary Color', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'transport'   => 'postMessage',
	'default'   => $disruptpress_theme_defaults['dp_site_container_color2'],
	'sanitize_callback'     => '',
	'alpha'       => true,
) );

$disruptpress_theme_defaults['dp_site_container_shade_strenght'] = '-0.5';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_site_container_shade_strenght',
	'description'       => esc_attr__( 'Shade Strenght', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'   => $disruptpress_theme_defaults['dp_site_container_shade_strenght'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '-1',
		'max'  => '1',
...
$disruptpress_theme_defaults['dp_site_container_gradient_style'] = '1';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'radio-image',
	'settings'    => 'dp_site_container_gradient_style',
	'description'       => esc_html__( 'Gradient Style', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'   => $disruptpress_theme_defaults['dp_site_container_gradient_style'],
	'transport'   => 'postMessage',
	'choices'     => array(
...
$disruptpress_theme_defaults['dp_site_container_gradient_advanced_toggle'] = '0';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'checkbox',
	'settings'    => 'dp_site_container_gradient_advanced_toggle',
	'label'       => __( 'Advanced Options', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'   => $disruptpress_theme_defaults['dp_site_container_gradient_advanced_toggle'],
	'transport'   => 'postMessage',
) );

$disruptpress_theme_defaults['dp_site_container_gradient_position_parameter1'] = '0';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_site_container_gradient_position_parameter1',
	'description'       => esc_attr__( 'Gradient Position Parameter 1', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'   => $disruptpress_theme_defaults['dp_site_container_gradient_position_parameter1'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '100',
...
$disruptpress_theme_defaults['dp_site_container_gradient_position_parameter2'] = '100';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'slider',
	'settings'    => 'dp_site_container_gradient_position_parameter2',
	'description'       => esc_attr__( 'Gradient Position Parameter 2', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'   => $disruptpress_theme_defaults['dp_site_container_gradient_position_parameter2'],
	'transport'   => 'postMessage',
	'choices'     => array(
		'min'  => '0',
		'max'  => '100',
...
$disruptpress_theme_defaults['dp_site_container_gradient_reverse_color'] = '0';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'switch',
	'settings'    => 'dp_site_container_gradient_reverse_color',
	'description'       => __( 'Reverse Colors', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'   => $disruptpress_theme_defaults['dp_site_container_gradient_reverse_color'],
	'transport'   => 'postMessage',
	'choices'     => array(
...
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'custom',
	'settings'    => 'dp_site_container_divider5',
	'section'     => 'dp_site_container',
	'default'     => '<div class="dp_customizer-divider"></div>',
) );

$disruptpress_theme_defaults['dp_site_container_img_panel'] = '1';
Kirki::add_field( 'disruptpress_theme', array(
	'type'      => 'radio-buttonset',
	'settings'  => 'dp_site_container_img_panel',
	'label'     => __( 'Background Image', 'my_textdomain' ),
	'section'   => 'dp_site_container',
	'default'   => $disruptpress_theme_defaults['dp_site_container_img_panel'],
	'transport' => 'postMessage',
	'choices'   => array(
...
$disruptpress_theme_defaults['dp_site_container_pattern'] = 'bg_noise_1.png';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'radio-image',
	'settings'    => 'dp_site_container_pattern',
	'description' => esc_html__( ' ', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'     => $disruptpress_theme_defaults['dp_site_container_pattern'],
	'transport'   => 'postMessage',
	'choices'     => array(
...
$disruptpress_theme_defaults['dp_site_container_img_upload'] = '';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'image',
	'settings'    => 'dp_site_container_img_upload',
	'label'       => __( ' ', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'     => $disruptpress_theme_defaults['dp_site_container_img_upload'],
	'transport'   => 'postMessage',
) );

$disruptpress_theme_defaults['dp_site_container_img_repeat'] = 'no-repeat';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'select',
	'settings'    => 'dp_site_container_img_repeat',
	'description'       => __( 'Background Repeat', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'     => $disruptpress_theme_defaults['dp_site_container_img_repeat'],
	'transport'   => 'postMessage',
	'multiple'    => 1,
	'choices'     => array(
...
$disruptpress_theme_defaults['dp_site_container_img_size'] = 'auto';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'select',
	'settings'    => 'dp_site_container_img_size',
	'description' => __( 'Background Size', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'     => $disruptpress_theme_defaults['dp_site_container_img_size'],
	'transport'   => 'postMessage',
	'multiple'    => 1,
	'choices'     => array(
...
$disruptpress_theme_defaults['dp_site_container_img_attachment'] = 'scroll';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'select',
	'settings'    => 'dp_site_container_img_attachment',
	'description' => __( 'Background Attachment', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'     => $disruptpress_theme_defaults['dp_site_container_img_attachment'],
	'transport'   => 'postMessage',
	'multiple'    => 1,
	'choices'     => array(
...
$disruptpress_theme_defaults['dp_site_container_img_position'] = 'left top';
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'select',
	'settings'    => 'dp_site_container_img_position',
	'description' => __( 'Background Position', 'my_textdomain' ),
	'section'     => 'dp_site_container',
	'default'     => $disruptpress_theme_defaults['dp_site_container_img_position'],
	'transport'   => 'postMessage',
	'multiple'    => 1,
	'choices'     => array(
...
Kirki::add_field( 'disruptpress_theme', array(
	'type'        => 'custom',
	'settings'    => 'dp_site_container_divider6',
	'section'     => 'dp_site_container',
	'default'     => '<div class="dp_customizer-divider"></div>',
) );